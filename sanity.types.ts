...
export type AllSanitySchemaTypes = Order | FilterOption | FilterType | Product | Brand | SubCategory | Category | SanityImagePaletteSwatch | SanityImagePalette | SanityImageDimensions | SanityImageHotspot | SanityImageCrop | SanityFileAsset | SanityImageAsset | SanityImageMetadata | Geopoint | Slug | SanityAssetSourceData;
...
// Variable: SUBCATS_QUERY
// Query: *[_type=='brand'] | order(name asc)
export type SUBCATS_QUERYResult = Array<{
  _id: string;
  _type: "brand";
  _createdAt: string;
  _updatedAt: string;
...
// Variable: GET_ALL_CategoryANDSUBCATEGORY
// Query: *[_type == 'category'] | order(name asc) [0...$quantity] {          ...,          "productCount": count(*[_type == "product" && references(^._id)]),          "subcategorieName": *[_type == "subCategory" && parentCategory._ref == ^._id]        }
export type GET_ALL_CategoryANDSUBCATEGORYResult = Array<{
  _id: string;
  _type: "category";
  _createdAt: string;
  _updatedAt: string;
...
declare module "@sanity/client" {
  interface SanityQueries {
    "*[_type=='brand'] | order(name asc) ": BRANDS_QUERYResult | SUBCATS_QUERYResult;
