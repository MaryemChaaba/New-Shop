      ...
      <div className="relative">
        ...
        >
          ...
          <button
            ...
            disabled={!canGoPrev}
            className={`absolute left-0 top-1/2 -translate-y-1/2 z-10 w-12 h-12 rounded-full bg-white shadow-lg border border-gofarm-green flex items-center justify-center transition-all duration-200 ${
              canGoPrev
                ? "hover:bg-blue-50 hover:border-blue-200 text-gofarm-green hover:text-gray-100"
          ...
          <button
            onClick={goToNext}
            disabled={!canGoNext}
            className={`absolute right-0 top-1/2 -translate-y-1/2 z-10 w-12 h-12 rounded-full bg-white shadow-lg border border-gofarm-green flex items-center justify-center transition-all duration-200 ${
              canGoNext
                ? "hover:bg-gofarm-green hover:border-gofarm-light-gray text-gofarm-green hover:text-gray-100"
                : "text-gray-300 cursor-not-allowed"
            }`}
          >
